...
export const metadata: Metadata = {
  title: "Nurse Registry Preview | The Nursing Council of The Bahamas",
  description:
    "Search the Nursing Council’s draft 500-record public registry preview.",
          ...
          <div className="container relative mx-auto grid gap-10 px-4 lg:grid-cols-[1fr_360px] lg:items-end">
            <div className="max-w-3xl">
              <p className="mb-5 flex items-center gap-3 text-sm font-semibold uppercase tracking-[0.16em] text-council-accent">
                ...
                Draft public registry
              </p>
              <h1 className="font-heading mb-5 text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl">
                Search the nurse registry preview.
              </h1>
              <p className="max-w-2xl text-lg leading-relaxed text-white/85">
                Browse a controlled 500-record sample using a nurse’s name,
          ...
          <div className="container mx-auto flex max-w-6xl items-start gap-4 px-4 py-5 text-amber-950">
            ...
            <div>
              <h2 className="font-heading font-bold">
                Draft sample — not a current-good-standing register
              </h2>
              <p className="mt-1 text-sm leading-relaxed">
                This preview is for testing the public registry experience.
                Inclusion confirms only that a historical Council registry
                record was selected for this sample. It does not confirm that a
                licence is current, active, or in good standing.
              </p>
            </div>
          </div>
        </section>
