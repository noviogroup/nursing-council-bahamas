      ...
      <main className="flex-1 bg-white">
        ...
        <section className="container mx-auto max-w-4xl px-4 py-16">
          <div className="space-y-8 text-gray-700">
            ...
            <section><h2 className="font-heading mb-3 text-2xl font-bold text-council-dark">Supported Access</h2><p>Visitors can navigate core pages, registration and enrollment links, renewal links, verification links, and contact information using standard browser and assistive technology controls.</p></section>
